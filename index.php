        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-md-7 py-4">
                    ...
                    <p class="text-white">To learn more <a href="about-us.php">about us</a></p>
                    <h4 class="text-white">Site Description</h4>
                    <p class="text-white">To learn more about <a href="site-description.php">site description</a></p>
                    <h4 class="text-white">Checklist</h4>
                    <p class="text-white">To learn more about <a href="checklist.php">checklist</a></p>
                </div>
