...
INSERT INTO `customer` (`cid`, `fullname`, `email`, `password`, `phone`,`isadmin`) VALUES
  ...
  (11, 'admin@gmail.com', 'admin@gmail.com', '1234', '123',1),
  (12, 'admin@admin.com', 'admin@admin.com', '1234', '123',1);
...
INSERT INTO `reservation` (`id`, `start`, `end`, `type`, `requirement`, `adults`, `children`, `requests`, `timestamp`, `hash`) VALUES
  (12, '2018-05-09', '2018-05-11', 'double', 'non smoking', 2, 0, '1', '2018-04-19 22:04:42', '5ad9127abbdf6'),
  (13, '2018-04-24', '2018-04-25', 'deluxe', 'no preference', 1, 0, '1', '2018-04-23 15:45:33', '5addff9dafa97'),
  (14, '2018-04-27', '2018-04-30', 'deluxe', 'no preference', 1, 0, '1', '2018-04-24 05:27:13', '5adec03166177');
